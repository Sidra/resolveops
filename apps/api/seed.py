...
async def seed():
    async with async_session() as session:
        ...
        audit_entries = [
            ...
            AuditLog(event_type=EventType.ai_response, actor="gemini-2.0-flash", ticket_id=t1.id,
            ...
            AuditLog(event_type=EventType.ai_response, actor="gemini-2.0-flash", ticket_id=t3.id,
            ...
            AuditLog(event_type=EventType.ai_response, actor="gemini-2.0-flash", ticket_id=t5.id,
